...
INCLUDE_PATTERNS = [
    ...
    "figures/*.svg",
    "figures/*.pdf",
    "pairwise_judge/final_pairwise_graphrag_qwen_vs_mini_*.csv",
    "pairwise_judge/final_pairwise_graphrag_qwen_vs_mini_*.json",
    "pairwise_judge/final_pairwise_graphrag_qwen_vs_mini_*.md",
    "pairwise_judge/figures/final_pairwise_graphrag_qwen_vs_mini_*.png",
    "pairwise_judge/figures/final_pairwise_graphrag_qwen_vs_mini_*.svg",
    "pairwise_judge/figures/final_pairwise_graphrag_qwen_vs_mini_*.pdf",
    "batch_metadata/*_manifest.json",
    "batch_metadata/*_answer_mapping.json",
    "batch_metadata/*_hidden_mapping.json",
